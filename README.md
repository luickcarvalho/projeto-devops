...
```
# matéria 1
curl -sv localhost:8080/api/comment/new -X POST -H 'Content-Type: application/json' -d '{"email":"alice@example.com","comment":"first post!","content_id":1}'
...
# listagem matéria 1
curl -sv localhost:8080/api/comment/list/1
